...
$Recordset1 = mysqli_connect("localhost","root", "","pms") or die(mysql_error());
$row_Recordset1 = mysqli_connect("localhost","root", "","pms");
$totalRows_Recordset1 = mysqli_connect("localhost","root", "","pms");
